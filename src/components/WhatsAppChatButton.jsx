...
function WhatsAppChatButton() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-[70] inline-flex items-center gap-3 rounded-full border border-green-400/25 bg-[#111]/92 px-4 py-3 text-white shadow-[0_18px_42px_rgba(0,0,0,0.35)] backdrop-blur transition hover:-translate-y-0.5 hover:bg-[#191919] sm:bottom-5 sm:right-5"
    >
      <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366] text-[#07120b]">
