  ...
  return (
    <section className="w-full px-2 py-16 sm:px-3 md:px-5 md:py-20 xl:px-6">
      <div className="glass-panel relative overflow-hidden rounded-[2rem] px-5 py-10 text-white sm:rounded-[2.2rem] sm:px-7 md:rounded-[2.5rem] md:px-12 md:py-14">
        ...
        <div className="absolute bottom-6 left-10 h-px w-48 bg-gradient-to-r from-transparent via-yellow-200/50 to-transparent" />
        <div className="relative grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          <div className="max-w-3xl">
            ...
            <TypeText
              as="h2"
              text={title}
              className="mt-4 font-display text-4xl leading-tight tracking-tight text-yellow-200 sm:text-5xl md:text-6xl"
              speed={16}
            />
            <TypeText
              as="p"
              text={text}
              className="mt-5 max-w-2xl text-lg leading-8 text-yellow-50/80"
              speed={8}
              caret={false}
            />
          </div>
